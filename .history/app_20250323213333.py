...
# 📄 **Resume Generator**
    ...
    # 🎖 Fetch Achievements for Resume
    achievements = get_achievements(st.session_state.username)
    achievements_text = "\n".join(achievements) if achievements else "No achievements added yet."
    ...
    if st.button("📜 Generate Resume"):
        resume_pdf = generate_resume(
            ...
            projects=projects,
            achievements=achievements_text  # 🔥 Including Achievements Here
        )
