...
if page == "🏠 Home":
    ...
    if st.button("📜 Generate Resume"):
        ...
        resume = generate_resume(name, email, phone, address, skills, education, experience, achievements)
        st.write("📃 Generated Resume:")
        st.download_button("📥 Download Resume", resume, "resume.pdf", "application/pdf")
