...
# 📄 **Resume Generator**
    ...
    # Add saved achievements if available
    ...
    # Add user-entered achievements if provided
    if user_achievements.strip():
        all_achievements_list.extend(user_achievements.split(","))  # Split user input by comma
